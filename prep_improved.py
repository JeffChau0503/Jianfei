...
type_dir1 = 'E:/imageset/Sphalerit grayscale'  # -----------------------------------------------------------更改2 文件保存路径
type_dir2 = 'E:/imageset/Sphalerit graph/'  # ---------------------------------------更改3 文件保存路径 注意: 最后的"/"不能省
...
for i in range(m):
    ...
    '''
    save_path = os.path.join(type_dir1, "7_" + str(i) + '.png')  # -----------------------更改4 更改类即"0_"数字
